...
if true then
  return M
end -- WARNING: Return short
-- language servers
M.ts = require("plugins.lsp.settings.ts")
M.lua = require("plugins.lsp.settings.lua")
M.marksman = require("plugins.lsp.settings.marksman")
M.json = require("plugins.lsp.settings.json")
